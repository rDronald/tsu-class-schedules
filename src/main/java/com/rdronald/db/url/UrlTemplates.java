package com.rdronald.db.url;

public final class UrlTemplates {
    private UrlTemplates() {
    }

    public static final String LOCAL_URL_GROUP_MANAGEMENT = "/group-management";
    public static final String LOCAL_URL_POST = "/post";
    public static final String LOCAL_URL_GET = "/get";
